...
D3D12Renderer::D3D12Renderer(UINT width, UINT height, HWND hwnd) :
...
void D3D12Renderer::LoadAssets()
{
    ...
    // Create the texture.
    {
        ...
        auto trans = CD3DX12_RESOURCE_BARRIER::Transition(m_textureY.Get(), D3D12_RESOURCE_STATE_COPY_DEST, D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE);
...
void D3D12Renderer::DrawFrame(const std::vector<BYTE>& frameData)
{
    texture = &frameData;
    OnUpdate();
    OnRender();
...
void D3D12Renderer::ChangeTextureSize(UINT width, UINT height)
{
    TextureWidth = width;
...
void D3D12Renderer::RotateTextureClockwise()
{
    auto tmp = rectVertices[0].uv;
    rectVertices[0].uv = rectVertices[3].uv;
    rectVertices[3].uv = rectVertices[2].uv;
    rectVertices[2].uv = rectVertices[1].uv;
    rectVertices[1].uv = tmp;
...
void D3D12Renderer::RotateTextureAnticlockwise()
{
    auto tmp = rectVertices[0].uv;
    rectVertices[0].uv = rectVertices[1].uv;
    rectVertices[1].uv = rectVertices[2].uv;
    rectVertices[2].uv = rectVertices[3].uv;
    rectVertices[3].uv = tmp;
...
void D3D12Renderer::FlipHorizontal()
{
    auto tmp = rectVertices[0].uv;
    rectVertices[0].uv = rectVertices[1].uv;
    rectVertices[1].uv = tmp;
    tmp = rectVertices[2].uv;
    rectVertices[2].uv = rectVertices[3].uv;
    rectVertices[3].uv = tmp;
